...
class modelosSNN():
    ...
    def predecir_comentario(comentario_texto, comentario_numeros):
        model = load_model("C:/Users/New Lenovo/opinionRestaurante/Recursos/modelo_entrenado.h5")
        print("RNN cargada")
        with open('C:/Users/New Lenovo/opinionRestaurante/Recursos/Pipetokenizercuatro.pickle', 'rb') as handle:
          pipeline = pickle.load(handle)
